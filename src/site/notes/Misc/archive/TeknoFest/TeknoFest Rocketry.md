---
{"dg-publish":true,"permalink":"/misc/archive/tekno-fest/tekno-fest-rocketry/"}
---
...
> - ![operation concept.png|600](/img/user/Misc/archive/TeknoFest/attachments/operation%20concept.png)
...
- ==Launch Conditions:== You must use the exact values shown on the “Launch Simulation” screen provided in Figure 3.2 of the rulebook (e.g., wind speed, launch site altitude, launch rod length). Reports missing simulations with these exact values will not be evaluated.
	- ![values_to_simulate for.png|500](/img/user/Misc/archive/TeknoFest/attachments/values_to_simulate%20for.png)
